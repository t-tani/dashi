...
from classifier import WORK, entry_of, load_env, make_lm, make_predictor
...
def main():
    ...
    with open(WORK + "/haiku-classifications.json", "w", encoding="utf-8") as sink:
    ...
    with open(WORK + "/haiku-semantic-class-table.tsv", "w", encoding="utf-8") as sink:
        for line in header:
